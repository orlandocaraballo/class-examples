...
import store, { loadData } from "./storeWithThunkCombined"; // imported for you already
...
/*
  we map the names of properties from the state
    to props:
    - state.counterReducer.count becomes props.countInReact in the component
    - state.studentsReducer.count becomes props.studentsInReact in the component
*/
